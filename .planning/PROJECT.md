...
A DCIM platform for micro data centers that unifies AC, UPS, and sensor telemetry into a single operational view. It is designed for MDC operators who currently rely on fragmented vendor tools. The platform normalizes multi-protocol device data and provides reliable alerting for daily operations.
...
- [ ] Connect real MDC devices over Modbus and SNMP with normalized telemetry model
...
- **Protocols**: Modbus and SNMP first - fastest path to covering common MDC equipment
...
|----------|-----------|---------|
| Protocol-first integration strategy (Modbus + SNMP) | Covers broad MDC equipment with practical v1 scope | - Pending |
